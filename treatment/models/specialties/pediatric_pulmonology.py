...
class pediatric_pulmonology_Patient(CommonModel):
    class Meta:
...
class PediatricPulmonologyProcedure(CommonModel):
...
class PediatricPulmonologyTest(CommonModel):
...
class pediatric_pulmonology_Treatment(CommonModel):
    class Meta:
