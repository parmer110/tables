...
# مدل بیمار
class sub_reproductive_endocrinology_infertility_Patient(CommonModel):
    class Meta:
...
class ReproductiveEndocrinology(CommonModel):
...
class sub_reproductive_endocrinology_infertility_Treatment(CommonModel):
    class Meta:
