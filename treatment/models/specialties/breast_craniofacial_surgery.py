...
# مدل بیمار
class breast_craniofacial_surgery_Patient(CommonModel):
    class Meta:
...
class BreastCraniofacialSurgery(CommonModel):
...
class breast_craniofacial_surgery_Treatment(CommonModel):
    class Meta:
