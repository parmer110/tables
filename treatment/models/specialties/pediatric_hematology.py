...
class pediatric_hematology_Patient(CommonModel):
    class Meta:
...
class PediatricHematologyProcedure(CommonModel):
...
class PediatricHematologyTest(CommonModel):
...
class pediatric_hematology_Treatment(CommonModel):
    class Meta:
