...
# مدل بیمار
class breast_reconstruction_surgery_Patient(CommonModel):
    class Meta:
...
class BreastReconstructionSurgery(CommonModel):
...
class breast_reconstruction_surgery_Treatment(CommonModel):
    class Meta:
