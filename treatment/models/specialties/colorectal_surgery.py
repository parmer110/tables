...
class colorectal_surgery_Patient(CommonModel):
    class Meta:
...
class ColorectalSurgeryProcedure(CommonModel):
...
class ColorectalSurgeryTest(CommonModel):
...
class colorectal_surgery_Treatment(CommonModel):
    class Meta:
